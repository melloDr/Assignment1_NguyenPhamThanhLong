 ...
 * @author Admin
 */
public class GetAllFoodController extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(GetAllFoodController.class);
     ...
     * else if ("1".equals(btnAction)||"2".equals(btnAction)||"3".equals(btnAction)) {
                url = GETALLFOOD;
            } 
     */
...
//            request.getRequestDispatcher("home.jsp").forward(request, response);
            list = daos.FoodDao.get20Foods(indexString);
